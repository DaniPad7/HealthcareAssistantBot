...
const ChatBot = () => {
    ...
    <div className="static chat-popup">
        <form className="form-container" id="my-form">
            ...
            <div style={{height: "35.9rem"}}></div>
            <div className="chat-input">
                <textarea className="" placeholder="Message..." maxLength={100}></textarea>
                <button className="chat__button btn-bottom-one" type="button" title="Send">
                    <span>
                        <picture>
                ...
                <button className="chat__button btn-bottom-two" type="button" title="Speech">
                    <span>
                    <picture>
